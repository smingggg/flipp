...
let scroll=()=>{
	...
	galleries.forEach((gallery)=>{
        let galleryElement=document.querySelector(gallery.id); //값이 많아질때 한꺼번에 받기 위한
		triggerFlipOnScroll(galleryElement,gallery.options) //id와 옵션값이 들어오는 것
    })
